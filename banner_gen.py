...
BANNER_PROMPT = (
    ...
    "empty ceiling, no empty floor, no large blank areas anywhere in the "
    "image. Every pixel from the left edge to the right edge, top to "
    "bottom, must be either part of her body, her hair, her dress, or "
    "the bedsheet/pillow directly around her.\n"
    "  • Her head and shoulders fill the right portion of the frame — "
    "her hair extends from the top edge to roughly mid-frame, her face "
    "occupies the right third, in sharp focus, looking straight at the "
    "camera.\n"
    "  • Her dress / black top / arm extends leftward across the frame, "
    "with the bedsheet visible around and beneath her, filling any "
    "remaining horizontal space all the way to the left edge.\n"
    "  • Tight crop. The image should feel densely composed and full, "
    "like a magazine cover or a streaming-platform hero banner — never "
    "sparse or minimal.\n"
